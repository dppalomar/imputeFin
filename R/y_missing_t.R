#' Synthetic Student's t AR(1) time series containing missing values for estimation and imputation testing purposes
#'
#' @docType data
#'
#' @usage data(AR1_t)
#'
#' @format A list consisting of the values of parameters of a Student's t AR(1) model and a zoo object 
...
#'   \item{nu}{value of nu used to generate the time series}
