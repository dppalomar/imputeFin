...
#'
#' Synthetic AR(1) Gaussian time series with missing values for 
#' estimation and imputation testing purposes.
#'
#' @docType data
#'
#' @usage data(ts_AR1_Gaussian)
#'
#' @format List with the following elements:
#' \describe{
#'   \item{y_missing}{300 x 3 \code{xts} object with three AR(1) Gaussian time 
